...
class accountmovelineshiping(models.Model):
    ...
    def create(self, vals_list):
        ...
        BUSINESS_FIELDS = ('price_unit', 'quantity', 'discount', 'tax_ids','re_shiping_test')
    ...
    def _get_price_total_and_subtotal_model(self, price_unit, quantity, discount, currency, product, partner, taxes,
        ...
        subtotal = quantity * line_discount_price_unit + re_shiping_test
        ...
        if taxes:
            ...
            res['price_subtotal'] = taxes_res['total_excluded']+re_shiping_test
    ...
    @api.onchange('quantity', 'discount', 'price_unit', 'tax_ids','re_shiping_test')
    def _onchange_price_subtotal(self):
        res = super(accountmovelineshiping, self)._onchange_price_subtotal()
        for rec in self:
            if rec.price_subtotal:
                rec.price_subtotal = rec.re_shiping_test + rec.price_subtotal
        return res
